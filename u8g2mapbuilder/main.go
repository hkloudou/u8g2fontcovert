...
func main() {
	...
	str := `欢迎进入卢教的人工智能语音识别带系统！，请选择一个菜单，请等待。正在烤羊肉，请稍等。错误操作牛筋倒计时时分秒年月日、黄瓜、藕片、青椒、土豆、面筋、韭菜、甜玉米、金针菇、烤茄子、正宗内蒙羊肉串、当日新鲜大串猪肉、烤五花肉、烤热狗、牛筋、烤脆骨、劲弹鸡爪、鸡胗、鱿鱼、虾、秋刀鱼、奥尔良鸡翅、蜜汁鸡翅、秘制鸡翅中、现杀烤鲫鱼`
